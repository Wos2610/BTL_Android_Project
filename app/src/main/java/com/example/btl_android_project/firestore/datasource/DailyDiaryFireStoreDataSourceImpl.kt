...
//    }
//
//    suspend fun getDailyDiaries(): Result<List<DailyDiary>> {
//        return try {
//            val snapshot = firestore.collection(COLLECTION_NAME).get().await()
//            Result.success(mapSnapshotToDailyDiaries(snapshot))
//        } catch (e: Exception) {
//            Result.failure(e)
//        }
//    }
//
//    suspend fun getDailyDiariesByUserId(userId: String): Result<List<DailyDiary>> {
//        return try {
//            val snapshot = firestore.collection(COLLECTION_NAME)
//                .whereEqualTo("userId", userId)
//                .get()
...
//    }
//
//    suspend fun getDailyDiaryById(id: String): Result<DailyDiary?> {
//        return try {
//            val document = firestore.collection(COLLECTION_NAME)
//                .whereEqualTo("id", id)
//                .get()
...
//                .firstOrNull()
//
//            Result.success(document?.let { mapDocumentToDailyDiary(it.data) })
//        } catch (e: Exception) {
//            Result.failure(e)
//        }
//    }
//
//    suspend fun getDailyDiaryByDate(userId: String, date: LocalDate): Result<DailyDiary?> {
//        return try {
//            val document = firestore.collection(COLLECTION_NAME)
//                .whereEqualTo("userId", userId)
//                .whereEqualTo("logDate", date.toString())
...
//    }
//
//    suspend fun insertDailyDiary(dailyDiary: DailyDiary): Result<String> {
//        return try {
//            // Tạo document reference mới với ID tự động từ Firebase
//            val docRef = firestore.collection(COLLECTION_NAME).document()
//
...
//            val diaryMap = mapDailyDiaryToDocument(updatedDiary)
//
//            // Thực hiện lưu dữ liệu
//            docRef.set(diaryMap).await()
//
//            // Trả về ID mới
...
//    }
//
//    suspend fun updateDailyDiary(dailyDiary: DailyDiary): Result<Unit> {
//        return try {
//            val diaryMap = mapDailyDiaryToDocument(dailyDiary)
//
//            firestore.collection(COLLECTION_NAME)
//                .document(dailyDiary.id)
//                .set(diaryMap)
...
//    }
//
//    suspend fun deleteDailyDiary(dailyDiary: DailyDiary): Result<Unit> {
//        return try {
//            firestore.collection(COLLECTION_NAME)
//                .document(dailyDiary.id)
//                .delete()
...
//    }
//
//    private fun mapDailyDiaryToDocument(dailyDiary: DailyDiary): Map<String, Any?> {
//        return mapOf(
//            "id" to dailyDiary.id,
//            "userId" to dailyDiary.userId,
//            "logDate" to dailyDiary.logDate?.toString(),
